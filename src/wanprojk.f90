...
subroutine wanprojk(ik,ld,nproj,mst,nst,vpl,idx,subulm,sublm,symlm,wanprj)
...
call genwfsvpwan(.true.,.false.,ikp,nst,idx(1:nst),ngdgc,igfc,vpl,ngp,igpig,wfmt, &
  ngtc,wfir)
...
do iorb=1,norb
  ...
  !apw radial function
    ...
    call wanolp(ias,nst,l,lmmax,u,wfmt,wantemp(:,:,:,iorb,ia)) 
