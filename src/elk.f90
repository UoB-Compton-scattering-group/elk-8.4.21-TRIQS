...
! check if task can be run with MPI
  if (lp_mpi.gt.0) then
    if (any(task.eq.[0,1,2,3,5,15,16,28,29,61,62,63,110,120,121,125,135,136, &
     ...
     804,805,806,807,808,809,820])) then !andj edit
      continue
    else
...
!BOI
! !TITLE: {\huge{\sc The Elk Code Manual}}\\ \Large{\sc Version 8.4.21}\\ \vskip 20pt \includegraphics[height=1cm]{elk_silhouette.pdf}
...
!   Yunfan Liang and Xavier Gonze. Special mention of David Singh's very useful
...
!
!   \vspace{12pt}
!   Berlin, Halle, Jerusalem and Uppsala, May 2022
!   \newpage
!
!   \section{Units}
