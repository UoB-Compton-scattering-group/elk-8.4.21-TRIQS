    ...
    do l=0,lmaxo
      do lm=l**2+1,(l+1)**2
        ...
        do io=1,apword(l,is)
          ...
          if (l.le.lmaxi) then
            call zfzrf(nri,z1,lrstp,apwfr(1,1,io,l,ias),lmmaxi,wfmt(lm,ispn,j))
          end if
          call zfzrf(nro,z1,lrstp,apwfr(iro,1,io,l,ias),lmmaxo,wfmt(i,ispn,j))
        end do
      end do
    end do
  end do
  ...
  do ispn=1,nspinor
    ...
    do ilo=1,nlorb(is)
      ...
      do lm=l**2+1,(l+1)**2
        ...
        if (ssdph) z1=z1*zq(ispn)
        if (l.le.lmaxi) then
          call zfzrf(nri,z1,lrstp,lofr(1,1,ilo,ias),lmmaxi,wfmt(lm,ispn,j))
        end if
        call zfzrf(nro,z1,lrstp,lofr(iro,1,ilo,ias),lmmaxo,wfmt(i,ispn,j))
      end do
    end do
  end do
end do
